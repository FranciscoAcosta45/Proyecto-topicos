...
public class ModalContraseña extends JFrame{
	...
	public ModalContraseña() {
		...
		ejemplo2 = new TextPrompt("Repetir la contraseña",txt_RepContra);
	...
	public static void main(String[] args) {
		ModalContraseña EjecuteLogin = new ModalContraseña();
